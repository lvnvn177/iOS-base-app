...
class PushNotificationManager: NSObject, UNUserNotificationCenterDelegate {
    ...
    func registerForPushNotificaitons() {
    ...
    func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) { // 원격 푸시 알림 등록 성공시 호출, 토근 생성
